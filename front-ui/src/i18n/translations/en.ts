...
const enMessages: Translations = {
  ...
  // home
  'home.title': 'Songle',
  'home.question': 'How many time will you need to retrieve this song ?',
  'home.guess-placeholder': 'Artist / Track',
  'home.guess-result': (time: number) => `Bravo ! You find it in ${time} seconds !`,
  'home.share': 'Share',
  'home.shareContent': (time: number) => `I found today's songle in ${time} seconds ! Can you do better ?`,
  'home.copied': 'Copied to clipboard !',
  'home.not-allowed': 'Press the play button first ;)',
