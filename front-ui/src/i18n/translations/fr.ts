...
const frMessages: Translations = {
  ...
  // home
  'home.title': 'Songle',
  'home.question': 'Combien de temps aurez-vous besoin pour retrouver le son ?',
  'home.guess-placeholder': 'Artiste / Musique',
  'home.guess-result': (time: number) => `Bravo ! Vous avez trouvé en ${time} seconds !`,
  'home.share': 'Partager',
  'home.shareContent': (time: number) => `J'ai trouvé le songle du jour en ${time} seconds ! Peux-tu faire mieux ?`,
  'home.copied': 'Copier dans le presse-papier !',
  'home.not-allowed': 'Click sur jouer d\'abord ;)',
