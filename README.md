...
--------------------
Just run the `com.qwicko.WebApplication` class, you can then open your browser to <http://localhost:8080>.
...
you can run the `com.qwicko.db.QuerydslGenerator.main()` method.
			...
			<configuration>
				<transformers>
					...
					<transformer
						...
						<mainClass>com.qwicko.WebApplication</mainClass>
					</transformer>
				</transformers>
			</configuration>
		</execution>
